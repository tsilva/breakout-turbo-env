...
- The `full` start must reproduce Stable Retro's `Breakout-Atari2600-v0` `Start` state at 160×210 pixels, including its 18×6 brick wall, 2×4 ball, initially 16×4 ceiling-narrowing paddle, five-life counter, FIRE-gated serves, paddle inertia, delayed collision latches, breakthrough speed, score raster, scanline priority, and wall/corner behavior.
- Changes to `full` start behavior must be acceptance-tested side by side against the live Stable Retro cartridge with identical generated actions and exact native-frame, reward, score, life, and terminal-state comparisons.
